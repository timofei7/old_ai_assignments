...
public class MMap
{
	...
	private void buildMap5()
	{
		...
		starts[0] = new Loc(29,3);  //has to navigate past 1
		finishes[0] = new Loc(20,3);
		
//		starts[1] = new Loc(28,3);
//		finishes[1] = new Loc(0,2); //blocks 0
//		
//		starts[2] = new Loc(27,3);
//		finishes[2] = new Loc(14,17);
//		
//		starts[3] = new Loc(26,3);
//		finishes[3] = new Loc(6,15);
//		
//		starts[4] = new Loc(25,3);
//		finishes[4] = new Loc(6,28);
...
//		
	...
	//poop 40x40 is too big to run... runs out of heap
//	
//	/**
//	 * build map 5
//	 */
